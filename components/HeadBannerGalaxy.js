    ...
    return (
        <section id="headbanner" className="galaxy flex relative mt-10 pt-20 sm:pt-0 sm:mt-0" style={{ height: 'calc(100vw / 16 * 9 + 5rem)' }}>
            <div className="flex top-0 left-0 relative justify-center items-center w-full overflow-hidden">
                <img alt={`Naughty Dragon Home Logo`} className="home-logo" src="/home/nd.webp" style={{
                    width: 'calc(38vw)',
            ...
            <img alt={`Naughty Dragon Cloud`} className="cloud" src="/home/cloud-3.webp" style={{
                position: 'absolute',
                minWidth: '100%',
                top: 0,
                left: 0,
            ...
            <img alt={`Naughty Dragon Cloud`} className="cloud" src="/home/cloud-4.webp" style={{
                position: 'absolute',
                minWidth: '100%',
            ...
            ></img>
            <img alt={`Naughty Dragon Cloud`} className="cloud" src="/home/cloud-1.webp" style={{
                position: 'absolute',
                width: 'calc(50vw)',
            ...
            <img alt={`Naughty Dragon Cloud`} className="cloud" src="/home/cloud-2.webp" style={{
                position: 'absolute',
                width: 'calc(50vw)',
