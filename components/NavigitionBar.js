        ...
        <section className={"navbar" + `${isClose ? ' closed' : ''}`}>
            ...
            <div className="nav-main-content">
                ...
                <ul className={`main-nav ${isOpen ? ' active' : ''}`}>
                    ...
                    <a rel="noreferrer" target="_blank" href="https://market.naughtydragon.io/" className="button mkt flex lg:hidden relative animate-glow cursor-pointer min-w-max hover:scale-105">
                        <span>Marketplace</span>
                        <img alt={`Naughty Dragon button`} className="max-h-20" src="btn.webp"></img>
                    </a>
                    <a rel="noreferrer" target="_blank" href="https://play.naughtydragon.io/" className="button flex lg:hidden relative animate-glow cursor-pointer min-w-max hover:scale-105">
